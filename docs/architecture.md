...
- **Mock LLM fallback**: guarantees the platform is fully demoable and
  testable with zero cost/keys, which matters for grading, CI, and anyone
  cloning the repo without an OpenAI key.
